...
selected_column = df['Career']

# Define the keywords to count
keywords = [
    "Reading industry publications and blogs",
    "Talking to professors, advisors, and mentors in my field",
    "Researching online resources and company websites.",
    "Connect with professionals online through platforms like LinkedIn or professional groups",
    "Participating in internships, job shadowing opportunities, or volunteer work.",
...
plt.title('Career Exploration Recommendations')
...
output_file_path = "C:\\Users\\aliso\\Downloads\\STEM_career_data.csv"
